...
1. **Authenticate stable server identity:** define the public identity,
...
3. **Prove Kotlin SRP and secure transport:** use cross-language protocol
   fixtures and a real YA server over one explicitly configured route.
