...
const MERGE_STRATEGIES: Array<{
  ...
  labelKey:
    | "sourceManagerMergeMethodMerge"
    | "sourceManagerMergeMethodSquash"
    | "sourceManagerMergeMethodRebase";
  descriptionKey:
    | "sourceManagerMergeMethodMergeHelp"
    | "sourceManagerMergeMethodSquashHelp"
    | "sourceManagerMergeMethodRebaseHelp";
}> = [
  {
    key: "merge",
    labelKey: "sourceManagerMergeMethodMerge",
    descriptionKey: "sourceManagerMergeMethodMergeHelp",
  },
  {
    key: "squash",
    labelKey: "sourceManagerMergeMethodSquash",
    descriptionKey: "sourceManagerMergeMethodSquashHelp",
  },
  {
    key: "rebase",
    labelKey: "sourceManagerMergeMethodRebase",
    descriptionKey: "sourceManagerMergeMethodRebaseHelp",
  },
];
...
export function GitBranchMergeModal({
  ...
  const branchGroups = useMemo(() => {
    ...
    return [
      {
        key: "default",
        title: t("sourceManagerBranchGroupDefault"),
      ...
      {
        key: "recent",
        title: t("sourceManagerBranchGroupRecent"),
        branches: branches.filter(
      ...
      {
        key: "other",
        title: t("sourceManagerBranchGroupOther"),
        branches: branches.filter(
  ...
  return (
    <Modal
      title={t("sourceManagerMergeDialogTitle", { branch: currentBranch })}
      onClose={onClose}
      backCloses
    >
          ...
          <div className="git-filter-bar">
            <div className="git-filter-field">
              ...
              <input
                ...
                placeholder={t("sourceManagerMergeFilterPlaceholder")}
        ...
        <div className="git-branch-merge-list">
          {branchGroups.length === 0 ? (
            <div className="git-branch-merge-empty">
              {t("sourceManagerMergeDialogEmpty")}
            </div>
          ) : (
          ...
          <div className={`git-branch-merge-status is-${statusState}`}>
            {statusState === "loading" ? (
              ...
              <>
                ...
                <p className="git-branch-merge-status-copy">
                  {highlightStatusText(
                    t("sourceManagerMergeConflict", {
                      count: preview.conflictedFiles,
                      sourceBranch: preview.sourceBranch,
                      targetBranch: preview.targetBranch,
                    }),
                    [
                      t("sourceManagerMergeConflictCountLabel", {
                        count: preview.conflictedFiles,
                      }),
                  ...
                  {highlightStatusText(
                    t(
                      preview.strategy === "rebase"
                        ? "sourceManagerMergeReadyRebase"
                        : "sourceManagerMergeReady",
                      {
                    ...
                    [
                      t("sourceManagerMergeCommitCountLabel", {
                        count: preview.commitCount,
                      }),
                      preview.sourceBranch,
                      preview.targetBranch,
        ...
        <div className="git-branch-merge-actions">
          <div className="git-branch-merge-submit" ref={strategyMenuRef}>
            ...
            <Button
              ...
              disabled={busy}
              aria-label={t("sourceManagerMergeMethodToggle")}
