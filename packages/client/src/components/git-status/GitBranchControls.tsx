...
function CopyBranchButton({
  ...
  return (
    <span
      ...
      title={
        copied ? t("sourceManagerHistoryHashCopied") : t("sourceManagerHistoryCopyHash")
      }
      aria-label={
        copied ? t("sourceManagerHistoryHashCopied") : t("sourceManagerHistoryCopyHash")
      }
      ...
      {isOpen ? (
        <>
          ...
          <button
            ...
            aria-label={t("sourceManagerCloseMenu")}
            onClick={onClose}
            onContextMenu={(e) => {
              e.preventDefault();
              onClose();
            ...
            <>
              <div className="git-branch-menu-filter">
                <div className="git-branch-menu-filter-row">
                  <div className="git-filter-bar">
                    <div className="git-filter-field">
                      ...
                      <input
                        ...
                        aria-label={t("sourceManagerMergeFilterPlaceholder")}
                      />
                      {filter.length > 0 ? (
                        <button
                          type="button"
                  ...
                  >
                    {t("sourceManagerBranchCreateButton")}
                  </button>
                </div>
              </div>
              {branchGroups.length === 0 ? (
                <div className="git-branch-merge-empty">
                  {t("sourceManagerBranchFilterEmpty")}
                </div>
              ) : null}
                  ...
                  {group.branches.map((branch) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {isCurrent ? (
                          <span className="git-head-badge" role="img" aria-label={t("sourceManagerBranchCurrent")}>HEAD</span>
                        ) : (
                          <span
                            role="button"
                            tabIndex={0}
                            className="git-branch-switch-button"
                            aria-label={t("sourceManagerBranchSwitchButton")}
                            title={t("sourceManagerBranchSwitchButton")}
                            onClick={(e) => {
                              e.stopPropagation();
                          ...
                          >
                            {t("sourceManagerBranchSwitchButton")}
                          </span>
                        )}
              ...
              <div className="git-branch-menu-footer">
                ...
                >
                  ...
                  <span className="git-branch-menu-action-label">
                    {t("sourceManagerMergeChooseBranch", {
