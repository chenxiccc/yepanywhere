  ...
  return createPortal(
    <>
      ...
      >
        ...
        >
          {t("gitStatusFileContextCopyName")}
        </button>
        <button
          type="button"
          role="menuitem"
        ...
        >
          {t("gitStatusFileContextCopyAbsolutePath")}
        </button>
        <button
          type="button"
          role="menuitem"
        ...
        >
          {t("gitStatusFileContextCopyRelativePath")}
        </button>
